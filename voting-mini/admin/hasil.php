...
<head>
  ...
  <title>Perolehan Suara - VotingAI</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            Tampilkan sebagai siaran live vote: <a href="live.php" class="btn btn-sm btn-primary"><li class="fas fa-eye"></li> Live Vote</a><hr>
          </div>
